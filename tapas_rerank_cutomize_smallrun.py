...
logging.basicConfig(
    filename='my_log_file_312.log',     # File to write logs to
...
folder_path = "/Users/inkitatewari/Documents/Semester 2/NLP/Group Project/Tapas/query csv result/top_chunks_top_312" 
...
output_rows = []
file_list = [f"query_{i}_top_312.csv" for i in range(0,2) if os.path.exists(os.path.join(folder_path, f"query_{i}_top_312.csv"))]
...
# output_csv = "ranked_results_78.csv"
...
output_csv = "ranked_results_312.csv"
header = ["Query", "Target table", "Target Table Rank", "Recall at 10%", "Recall at 20%"]
